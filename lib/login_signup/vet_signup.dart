  ...
  void _register() async {
    try {
      ...
      await userDocRef.set({
        ...
        'isVet':
            'false', // Kullanıcının adını veya diğer bilgileri buraya ekleyebilirsiniz
      ...
      print(
          'Kullanıcı kaydedildi, Firestore dökümanı oluşturuldu ve resim Firebase Storage\'a yüklendi.');
    } catch (e) {
